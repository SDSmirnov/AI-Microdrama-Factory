...
Visual variety across a multi-episode series is not optional — monotone color grade kills mid-video retention. Each location type has its own color key. The contrast between signatures makes location changes VISIBLE IN THE EDIT without any title card.
