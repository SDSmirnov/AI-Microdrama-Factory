...
# CONTEXT: We produce VERTICAL MICRODRAMA for DramaBox / ReelShort (9:16 portrait).
# CAPTIVE AUDIENCE: Viewers are subscribers or pay-per-unlock. They know the show and the characters.
# Each scene = 9 panels × ~6s raw = 54s footage → ~27s after edit. Violence and hard dramatic content allowed (fictional source).
