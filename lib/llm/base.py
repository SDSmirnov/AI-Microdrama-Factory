...
def retry_on_errors(max_retries=3, backoff_factor=2):
    """Retry decorator on 429/500/502/503 / rate limit / server errors."""
    def decorator(func):
            ...
            while retries < max_retries:
                try:
                    ...
                    retryable = (
                        ...
                        bool(re.search(r'\b(429|500|502|503)\b', error_str)) or
                        'Too Many Requests' in error_str or 'Rate limit' in error_str or
                        'Internal Server Error' in error_str or 'Bad Gateway' in error_str or 'Service Unavailable' in error_str or
